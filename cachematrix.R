## Week3_Assignment: Caching the Inverse of a Matrix
...
## Create a special matrix that stores a matrix and caches its inverse.
...
## sourced your code with the typo fixed
